	...
	<div class="row">
      <div class="col-md-6 col-md-offset-3">
        <div class="well well-sm">
          <form:form class="form-horizontal" action="${pageContext.request.contextPath}/projectManagement/projectAddition" method="post" role="form"  modelAttribute="additionProject">
          <fieldset>
